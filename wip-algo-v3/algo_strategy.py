...
# todo: consider pluggin holes while saving up. have more consistent attacks
# todo: add reactive turrets, when walls are broken through, build turrets there the next round
# todo: make a U shape with the wall so that it's out of range of destructors, see high level replays saved
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def build_defences(self, game_state):
        ...
        secondary_turrets = [[5, 10], [7, 10], [9, 10], [18, 10], [20, 10], [22, 10]]
        ...
        game_state.attempt_upgrade(turret_upgrades)
    ...
    def demolisher_line_strategy(self, game_state):
        ...
        game_state.attempt_spawn(DEMOLISHER, [7, 6], 2)
